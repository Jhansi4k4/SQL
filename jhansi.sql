...
insert into books values('zootopriya','ramshettie','comedy',2021,1200.00);
insert into books values('encantio','jane','suspence',2015,1000.00);
insert into books values('rollig','suspence',2014,1200.00);
select * from books;
select book_title from books;
update books set price=50 where book_title='harraypotter';
